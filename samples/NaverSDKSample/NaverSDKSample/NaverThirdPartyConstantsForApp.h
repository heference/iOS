...
#define kCheckResultPage        @"iOSNaverSDKSample"
...
#define kServiceAppUrlScheme    @"com.heference.NaverSDKSample"

#define kConsumerKey            @"mOudsaraE9d5mXSNbqil"
#define kConsumerSecret         @"8YlVh7Wiey"
#define kServiceAppName         @"iOSNaverSDKSample"
